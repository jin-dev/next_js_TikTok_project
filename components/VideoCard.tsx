...
const VideoCard: NextPage<IProps> = ({ post } )  => {
  ...
  useEffect(() => {
    ...
    return (
      ...
      <div className="md:w-16 md:h-16 w-10 h-10"></div>
      ...
      <div className="lg:md-20 flex gap-4 relative">
        <div onMouseEnter={() => setIsHover(true)} onMouseLeave={() => setIsHover(false)} className="rounded-3xl"></div>
